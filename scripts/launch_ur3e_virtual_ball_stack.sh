...
PUBLISH_FRAME="${UR3E_BALL_PUBLISH_FRAME:-base}"
TRIGGER_MODE="${UR3E_BALL_TRIGGER_MODE:-true}"
LAUNCH_LATENCY_REPORT="${UR3E_LAUNCH_LATENCY_REPORT:-false}"
PUBLISH_HOOP_TF="${UR3E_PUBLISH_HOOP_TF:-false}"
HOOP_XYZ="${UR3E_HOOP_XYZ:-0.0 0.0 0.0}"
HOOP_QUAT="${UR3E_HOOP_QUAT:-0.0 0.0 0.0 1.0}"
